...
def evaluate(k):
    # Load ground truth from cross-encoder-based test collection
    # print(os.curdir)
    ...
    with open("evaluations/results/evaluation_results_from_crossencoder_after_reranking.json", "w") as f:
        json.dump(detailed_results, f, indent=2)

    avg_score = sum(ndcg)/len(ndcg)
    print(f"\n✅ Evaluation completed after reranking — Avg NDCG@10: {avg_score}")
